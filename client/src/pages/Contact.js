        ...
        <main>
            <div className='mt-4'>
                <div className='card-header p-auto' >
                    <h3 style={{ fontWeight: 700, fontSize: "3rem", border: "solid 5px #049434", backgroundColor: "rgba(0,0,0,.5)" }} className='text-light text-center'>Contact Information</h3>
                </div>
                <div className='card-body col-sm-12 text-shrink' style={{ maxWidth: 800, backgroundColor: "rgba(0,0,0,.5)" }}>
